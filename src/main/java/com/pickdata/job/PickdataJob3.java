...
import com.pickdata.mapper.PickdataMapper3;
import com.pickdata.reducer.PickdataReducer3;
...
public class PickdataJob3 extends Configured implements Tool {

	static Log log = LogFactory.getLog(PickdataJob3.class);

	public static void main(String[] args) throws Exception {

		ToolRunner.run(new PickdataJob3(), args);
	}
	...
	public int run(String[] arg0) throws Exception {
		...
		job.setJarByClass(PickdataJob3.class);
		...
		//mapper 설정
		job.setMapperClass(PickdataMapper3.class);
		...
		job.setReducerClass(PickdataReducer3.class);
