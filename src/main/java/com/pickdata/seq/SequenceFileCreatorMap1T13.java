...
public class SequenceFileCreatorMap1T13 extends Configured implements Tool {

	static Log log = LogFactory.getLog(SequenceFileCreatorMap1T13.class);
	...
	public static void main(String[] args) throws Exception {
		...
		//분산 캐시 역할
		ToolRunner.run(new SequenceFileCreatorMap1T13(), args);
	...
	public int run(String[] arg0) throws Exception {
		...
		job.setJarByClass(SequenceFileCreatorMap1T13.class);
		...
		/////////////////////////맵리듀스/////////////////////
		job.setMapperClass(Mapper1T13.class);
		...
		Path outputDir = new Path("/home/java/pickdata/sample/sequence/t13");
