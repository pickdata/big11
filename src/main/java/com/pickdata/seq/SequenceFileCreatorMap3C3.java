...
public class SequenceFileCreatorMap3C3 extends Configured implements Tool {

	static Log log = LogFactory.getLog(SequenceFileCreatorMap3C3.class);
	...
	public static void main(String[] args) throws Exception {
		...
		//분산 캐시 역할
		ToolRunner.run(new SequenceFileCreatorMap3C3(), args);
	...
	public int run(String[] arg0) throws Exception {
		...
		/////////////////////////맵리듀스/////////////////////
		job.setMapperClass(Mapper3C3.class);
