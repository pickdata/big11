...
public class SequenceFileCreatorMap5I19 extends Configured implements Tool {

	static Log log = LogFactory.getLog(SequenceFileCreatorMap5I19.class);
	...
	public static void main(String[] args) throws Exception {
		...
		//분산 캐시 역할
		ToolRunner.run(new SequenceFileCreatorMap5I19(), args);
	...
	public int run(String[] arg0) throws Exception {
		...
		job.setJarByClass(SequenceFileCreatorMap5I19.class);
		...
		/////////////////////////맵리듀스/////////////////////
		job.setMapperClass(Mapper5I19.class);
